...
export function TournamentErrorState({ statusCode = 404, message }: TournamentErrorStateProps): ReactNode {
  const isNotFound = statusCode === 404
  const title = isNotFound ? 'Tournament Not Found' : 'Unable to Load Tournament'
  const description = message || (isNotFound
    ? 'The tournament you\'re looking for doesn\'t exist or has been removed.'
    : 'Something went wrong while loading the tournament details. Please try again.')
